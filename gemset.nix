{
  ...
  github-pages = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1bbhdpvjzqjinycbcnl1sp607acni2n2df5am5vc7d8w6qd791ag";
      type = "gem";
    };
    version = "177";
  };
  ...
  minimal-mistakes-jekyll = {
    dependencies = ["jekyll" "jekyll-data" "jekyll-feed" "jekyll-gist" "jekyll-paginate" "jekyll-sitemap" "jemoji"];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "04s8x9ipbvps0hnmrqclq0pqwxzdqyq3vbg3p2w3c1fhhagh2vww";
      type = "gem";
    };
    version = "4.10.0";
  };
